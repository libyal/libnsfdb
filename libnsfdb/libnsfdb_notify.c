...
{
	static char *function = "libnsfdb_notify_set_stream";
...
int libnsfdb_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libnsfdb_notify_stream_open";
...
int libnsfdb_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libnsfdb_notify_stream_close";
