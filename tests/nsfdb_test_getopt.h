...
#if !defined( _NSFDB_TEST_GETOPT_H )
#define _NSFDB_TEST_GETOPT_H
...
#define nsfdb_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t nsfdb_test_getopt(
                  int argument_count,
...
#endif /* !defined( _NSFDB_TEST_GETOPT_H ) */
